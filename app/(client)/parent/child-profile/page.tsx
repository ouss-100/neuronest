...
const ChildProfile = () => (
  <div className="space-y-6 max-w-4xl">
    <Link href="/parent" className="inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition-colors">
    ...
    <div className="card-soft flex flex-col sm:flex-row items-start sm:items-center gap-6">
      ...
      <div className="flex-1">
        <h1 className="text-2xl font-heading font-bold text-foreground">Emma</h1>
      ...
      <Link href="/parent/assessment" className="btn-accent !px-5 !py-2.5 text-sm">New Assessment</Link>
    </div>

    {/* Progress */}
    <div className="card-soft">
      <h2 className="font-heading font-bold text-lg text-foreground mb-4">Progress Over Time</h2>
        ...
        <div className="flex items-end gap-6 h-full py-6 px-8">
          {[68, 75, 82].map((val, i) => (
            <div key={i} className="flex flex-col items-center gap-2">
              ...
              >
                <div className="absolute bottom-0 left-0 right-0 bg-primary rounded-xl" style={{ height: `${val}%` }} />
              </motion.div>
    ...
    {/* Assessment History */}
    <div>
      <h2 className="font-heading font-bold text-lg text-foreground mb-4">Assessment History</h2>
        ...
        {assessments.map((a, i) => (
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="font-heading font-semibold text-foreground text-sm">{a.type}</p>
            ...
            <div className="flex items-center gap-3">
              ...
              <Link href="/parent/results" className="text-sm text-primary font-semibold hover:underline">View</Link>
            </div>
          </motion.div>
        ))}
      </div>
