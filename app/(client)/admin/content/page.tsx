...
const content = [
  { title: "Signs Your Child May Have a Learning Disorder", type: "Article", status: "published", date: "Mar 10, 2026" },
  { title: "Understanding Dyslexia: A Parent's Guide", type: "Guide", status: "published", date: "Mar 5, 2026" },
  { title: "ADHD Support Strategies", type: "Article", status: "draft", date: "Mar 12, 2026" },
  { title: "Building Confidence in Struggling Learners", type: "Tips", status: "published", date: "Feb 28, 2026" },
];
...
const AdminContent = () => (
  <div className="space-y-6 max-w-5xl">
    <div className="flex justify-between items-center">
      <div>
        <h1 className="text-2xl lg:text-3xl font-heading font-bold text-foreground">Content Management</h1>
        <p className="text-muted-foreground mt-1">Manage articles, guides, and resources</p>
      </div>
      ...
      {content.map((item, i) => (
        ...
        >
          ...
          <div className="flex items-center gap-2">
            <span className={item.status === "published" ? "badge-completed" : "badge-pending"}>{item.status}</span>
