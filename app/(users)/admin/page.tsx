...
import { Users, ClipboardList, BarChart3, TrendingUp, Activity, ArrowUpRight, Calendar } from "lucide-react";
import StatCard from "@/components/StatCard";

const recentActivity = [
  { text: "New parent registration: Ana Martinez", time: "1 hour ago", type: "user" },
  { text: "Assessment completed: Oliver Chen (Score: 82%)", time: "3 hours ago", type: "assessment" },
  { text: "Dr. Smith submitted evaluation for Emma Johnson", time: "5 hours ago", type: "doctor" },
  { text: "New article published: Early Signs of Dyslexia", time: "1 day ago", type: "content" },
  { text: "Parent Sarah J. requested doctor consultation", time: "1 day ago", type: "appointment" },
  { text: "Platform maintenance completed successfully", time: "2 days ago", type: "system" },
];
...
const AdminDashboard = () => (
  <div className="space-y-6">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      <StatCard icon={Users} label="Total Users" value="1,247" change="+12% this month" color="primary" />
      <StatCard icon={ClipboardList} label="Assessments" value="3,892" change="+8% this month" color="secondary" />
      <StatCard icon={BarChart3} label="Completion Rate" value="87%" color="accent" />
      <StatCard icon={TrendingUp} label="Active Doctors" value="24" change="+3 new" color="primary" />
    </div>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <div className="lg:col-span-2 card-soft">
        <div className="flex items-center justify-between mb-6">
          <h2 className="font-heading font-bold text-lg text-foreground">Assessments Over Time</h2>
      ...
      <div className="card-soft">
        <h2 className="font-heading font-bold text-lg text-foreground mb-5">Top Assessments</h2>
